...
function ProceedButton({ page, text }) {
  return (
    <Link
      to={`/${page}`}
      className={`left-arrow absolute right-10 bottom-3 z-1 -translate-y-1/2 ${page === "result" && "animate-fade-right"} text-sm transition-all duration-900 ease-in-out`}
    >
