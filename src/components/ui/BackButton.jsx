  ...
  return (
    ...
    >
      <div className="group flex items-center gap-x-7">
        ...
        >
          <span
            className={`left-0 flex aspect-square w-[40px] ${gray && "text-gray-200"} -translate-x-[2px] translate-y-[2px] -rotate-45 items-center justify-center text-center`}
          >
            ◀
          </span>
        </div>
        <span className={`font-semibold ${gray && "text-gray-200"}`}>BACK</span>
      </div>
    </Link>
  );
}
